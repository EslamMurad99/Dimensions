...
<head>
  ...
  <link rel="stylesheet" href="{{ secure_asset('css/services-parallax.css') }}">
...
<body>
  ...
  <main class="main-content">
    ...
    <section class="concept concept-eight">
      <a href="contact.blade.php" class="contact-link" style="text-decoration: none; color: inherit; display: block;">
        <h1 class="word">
  ...
  <script src="{{ secure_asset('js/services-background.js') }}"></script>
